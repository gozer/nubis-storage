...
package { 'libnspr4':
  ensure => '2:4.10.10-0ubuntu0.14.04.1',
}
package { 'libnss3':
  ensure => '2:3.21-0ubuntu0.14.04.2',
}
...
package { 'libunwind8':
  ensure => '1.1-2.2ubuntu3',
}
package { 'liburcu1':
  ensure => '0.7.12-0ubuntu2',
}
package { 'liburi-perl':
  ensure => '1.60-1',
}
